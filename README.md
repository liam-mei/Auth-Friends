...
* There is an API built that has authentication built into it.
* The API holds a list of friends and lets you add, edit, or remove friends from that list.
...
* Create a protected route for your friends list.
  * Remember, if the user isn't logged in, navigating to this protected route will redirect them to the login page.
...
## MVP
 ...
 - [ ] Saving Token
 - [ ] FriendsList Page - protected
 - [ ] Post Friend Page - protected
